...
It seems on older model iphones on IOS 16 the memory usage is higher, so i have made this tweak to fix WhatsApp notifications on these devices. The 112MB should be enough for everyone. Start at the lowest and work up (userspace reboot between each change for them to be applied).
